...
train_examples, val_examples = load_language_dataset('ted_hrlr_translate/pt_to_en') 
...
def vocab_generator():
    ...
    time
    train_lan, _ = map_examples(train_examples)
...
file_vocabulary_lan = write_vocab_file('vocabularylan.txt', lan_vocab)
